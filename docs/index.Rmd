...
full_prescirption_dataset %>% 
  ...
  labs(title = "Figure 1. Gross prescription of contraceptives between 2016 and 2023", x = "Year", y = "Number of items dispensed") +
...
ggplot() +
  geom_line(data = long_term_contraception_yearly_gross, aes(y = sum, x = year), color = "#6D91F2") +
  geom_line(data = short_term_contraception_yearly_gross, aes(y = sum, x = year), color = "#6DF2A6") +
  geom_vline(xintercept = 2020, color="grey", size=.5, linetype = "dashed") +
  geom_vline(xintercept = 2022, color="grey", size=.5, linetype = "dashed") +
  theme_classic() +
  theme(plot.title = element_text(size = 13, 
                                  ...
                                  axis.title.x = element_text(size = 11, margin=margin(10,0,0,0)), 
                                  axis.title.y = element_text(size = 11, margin=margin(0,10,0,0))) +
  labs(title = "Figure 2. Normalised prescription of long-term and short-term contraceptives", x = "Year", y = "Normalised value of items dispensed per year") +
