...
long_term_contraception %>% 
  ...
  geom_line(data=plot_contraceptives_long_term %>% dplyr::select(-hb_name), aes(group=hb_name1), color="grey", size=0.5, alpha=0.5) +
  geom_line(aes(color=hb_name), color="#69b3a2", size=1.2 )+
  theme_classic() +
  theme(plot.title = element_text(size = 13, 
                                  hjust = 0,
                                  face = "bold", 
  ...
  labs(title = "Long-term contraceptive items per 1000 women", x = "Year", y = "Number of items per 1000 women") +
  facet_wrap(~hb_name)
