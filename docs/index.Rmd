...
print(ggplot() +
  geom_line(data = long_term_contraception, aes(y = sum, x = year), color = "#6D91F2", linewidth = 2) +
  geom_line(data = short_term_contraception, aes(y = sum, x = year), color = "#6DF2A6", linewidth=2) +
